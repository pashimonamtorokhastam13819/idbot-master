...
----config----
local bot_api_key = "223605535:AAFZihrL5-s6x1VpXvENEXoNzuUTbVybg_s" 
local You = 147237496,174997972
...
function bot_run()
  ...
  if not add then
	...
	local bot_info = "Username = @"..bot.username.."\nName = "..bot.first_name.."\nID = "..bot.id.." \n[jon the Kiava channel](https://telegram.me/kiavaprotection)"
...
local text = "سلام ["..msg.from.first_name.."](www.telegram.me/"..user..")\n\n[خرید ربات تلگرام](http://telegram.me/mohammad_NBG)"
sendMessage(msg.chat.id,text.."\n"..start,true,false,true)
